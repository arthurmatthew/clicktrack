...
export const TempoIncrementButton = ({
  ...
  return (
    <i
      ...
      className={`bi-${icon} flex grow cursor-pointer items-center justify-center border-x border-white bg-zinc-200 py-2 text-2xl tracking-tighter duration-75 hover:bg-zinc-900 hover:text-white dark:border-black dark:bg-zinc-900 dark:hover:bg-zinc-200 dark:hover:text-black`}
    />
  );
};
