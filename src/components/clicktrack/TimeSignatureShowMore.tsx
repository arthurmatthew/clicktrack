...
export const TimeSignatureShowMore = ({
  ...
  return (
    ...
    >
      <h1 className="flex h-full w-full flex-col items-center justify-center border-neutral-200 bg-white p-2 py-5 leading-none duration-75 group-hover:text-purple-500 dark:border-neutral-900 dark:bg-black">
