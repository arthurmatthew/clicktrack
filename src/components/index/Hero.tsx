    ...
    <>
      <section className="mx-2 my-20 flex justify-center">
        <div className="flex w-full max-w-7xl justify-between">
          ...
          <div className="grid h-[500px] w-[400px] grid-cols-3 grid-rows-3 rounded-lg">
            {[
              'file-music',
              'hourglass-split',
              'music-note-beamed',
      ...
      <section className="flex justify-center text-black">
        <div className="grid w-full max-w-7xl grid-cols-12 grid-rows-2 gap-1">
          <div className="col-span-6 rounded-md bg-purple-300">
          ...
          <div className="col-span-6 rounded-md bg-fuchsia-300">
            <div className="flex flex-col gap-2 p-6">
              <h3 className="text-xl">
          ...
          <div className="col-span-5 rounded-md bg-purple-200">
            <div className="flex flex-col gap-2 p-6">
              <h3 className="text-xl">
          ...
          <div className="col-span-7 rounded-md bg-pink-200">
            <div className="flex flex-col gap-2 p-6">
              <h3 className="text-xl">
      ...
      <section className="mx-2 flex justify-center">
        <div className="flex w-full max-w-7xl flex-col justify-between gap-6">
          ...
          <ul className="list-disc text-2xl text-purple-900 dark:text-purple-200">
