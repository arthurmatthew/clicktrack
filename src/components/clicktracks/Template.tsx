...
export const Template = ({ title, onClick, children }: ITemplate) => {
  return (
    <button
      onClick={onClick}
      className="relative flex h-full w-full select-none flex-col items-center gap-2 overflow-hidden rounded-md border-[1px] border-zinc-300 bg-white p-4 duration-75 hover:-translate-y-1 hover:bg-zinc-100 dark:border-zinc-700 dark:bg-black dark:hover:bg-zinc-900 sm:gap-4 sm:p-8"
    >
