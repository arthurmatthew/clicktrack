const Footer = () => {
  return (
    <footer className="flex shrink grow-0 basis-44 flex-wrap justify-evenly bg-slate-900 px-4 py-12 leading-loose text-purple-100 lg:px-64 xl:px-72 2xl:px-96 [&>*]:px-4">
