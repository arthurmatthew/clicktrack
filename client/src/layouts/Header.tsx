...
const Header = ({
  ...
  return (
    <header className="bg-gradient-radial sticky top-0 z-10 shrink grow-0 basis-auto from-slate-100 to-slate-300 bg-[length:100%_200%] bg-[100%_0] p-5 dark:from-slate-800 dark:to-slate-950">
